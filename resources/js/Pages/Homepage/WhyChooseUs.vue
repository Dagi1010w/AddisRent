...
// 2. Activate composable for translations
const { t } = useLanguage();
...
const features = ref([
  {
    ...
    descriptionKey: 'whyUs.verified.desc',
    statsKey: 'whyUs.verified.title', // Example, adjust if you have specific stat keys
  },
  {
    icon: Zap,
    titleKey: 'whyUs.support.title', // Note: Your react code used different titles. I am using your translation.ts keys.
    descriptionKey: 'whyUs.support.desc',
    statsKey: 'whyUs.support.title',
  },
  {
    icon: Lock,
    titleKey: 'whyUs.secure.title',
    descriptionKey: 'whyUs.secure.desc',
    statsKey: 'whyUs.secure.title',
  },
]);

// 4. Define the additional stats section data
const additionalStats = ref([
  { icon: Users, value: '50K+', labelKey: 'hero.stats.customers' },
  { icon: CheckCircle, value: '10K+', labelKey: 'hero.stats.properties' },
  { icon: Star, value: '4.9', labelKey: 'hero.stats.rating' },
]);
</script>
