...
const regions = [ { value: "addis-ababa", label: "Addis Ababa / አዲስ አበባ" }, { value: "oromia", label: "Oromia / ኦሮሚያ" }, { value: "amhara", label: "Amhara / አማራ" }, { value: "tigray", label: "Tigray / ትግራይ" }, { value: "snnp", label: "SNNP / ደቡብ ክልል" } ];
...
{ value: "apartment", label: "Apartment / አፓርታማ" }, { value: "villa", label: "Villa / ቪላ" }, { value: "house", label: "House / ቤት" },{ value: "office", label: "Office / መሥሪያ ቤት" }, { value: "land", label: "Land / መሬት" },{value: "Building", label: "Building / ህንፃ"},{ value: "shop", label: "Shop / መደብር" }, { value: "studio", label: "Studio / ስቱዲዮ" },{ value: "condominum", label: "Condo / ኮንዶሚኒየም" }, { value: "warehouse", label: "Warehouse / መጋዘን" },  ];
